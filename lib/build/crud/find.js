...
(function() {
  var ObjectID, async, convertIdsInWhere, modeler, mongo, mongodb, _;
  ...
  exports.find = function(_type, query, callback) {
    ...
    return async.series([
      function(next) {
        ...
        return collection.find(query.where, query.select, options).toArray(function(err, result) {
          var doc, _i, _len;
          if (err) {
  ...
  convertIdsInWhere = function(where) {
    var _id, _ref;
