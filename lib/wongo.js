...
(function() {
  var Schema, async, create, find, findById, findOne, mongoose, normalize_populate, remove, removeAll, run_populate_queries, save, saveAll, update, _,
  ...
  exports.save = save = function(_type, document, callback) {
    ...
    if (document._id) {
      ...
      return update(_type, {
        ...
        return findById(_type, _id, callback);
      });
    } else {
  ...
  exports.remove = remove = function(_type, _id, callback) {
    var Type;
    Type = mongoose.model(_type);
    return Type.findByIdAndRemove(_id, callback);
  };
  ...
  run_populate_queries = function(Type, populateArray, docs, callback) {
    return async.forEach(populateArray, function(prop, nextInLoop) {
