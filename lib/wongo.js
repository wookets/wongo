...
(function() {
  var async, convert_ids_to_string, count, create, find, findById, findOne, mongoose, normalize_populate, remove, removeAll, run_populate_queries, save, saveAll, update, update_properties, _,
  ...
  convert_ids_to_string = function(doc) {
    var item, newVal, prop, val, _results;
    _results = [];
    for (prop in doc) {
      ...
      if (_.isArray(val)) {
        ...
        _results.push((function() {
          ...
          for (_i = 0, _len = val.length; _i < _len; _i++) {
            ...
            if (item instanceof mongoose.Types.ObjectId) {
              _results1.push(newVal.push(String(item)));
            } else if (_.isObject(item)) {
              _results1.push(convert_ids_to_string(item));
            } else {
              _results1.push(void 0);
            }
          }
        ...
        _results.push(convert_ids_to_string(val));
      } else {
        _results.push(void 0);
      }
    }
