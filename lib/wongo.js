...
(function() {
  var async, convert_ids_to_string, count, find, findById, findOne, mongoose, normalize_populate, ns, remove, removeAll, run_populate_queries, save, saveAll, update, update_properties, _,
